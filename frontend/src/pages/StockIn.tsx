...
import { ArrowDownCircle, Package, Calendar, FileText, Building, User, StickyNote, CheckCircle, TrendingUp } from 'lucide-react';
    ...
    return (
        <div className="max-w-4xl mx-auto">
            <div className="mb-8">
                ...
                <p className="text-cocoa/60 mt-2">Record new material and equipment arrivals</p>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className="w-full px-4 py-3 bg-cream border border-cocoa/10 rounded-lg text-cocoa focus:ring-2 focus:ring-green-500/50 focus:border-green-500 outline-none text-base transition-all"
                        >
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows={3}
                            className="w-full px-4 py-3 bg-cream border border-cocoa/10 rounded-lg text-cocoa focus:ring-2 focus:ring-green-500/50 focus:border-green-500 outline-none text-base resize-none transition-all"
                    ...
                    <div className="flex gap-4 pt-4">
                        <button
                            ...
                            className="flex-1 px-8 py-4 bg-gradient-to-r from-green-600 to-green-700 text-white hover:from-green-700 hover:to-green-800 rounded-xl font-bold text-lg transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                        >
                ...
                <div className="flex gap-3">
                    ...
                    <div>
                        ...
                        <ul className="text-sm text-blue-800 space-y-1">
                            ...
                            <li>• Reference and supplier information helps with tracking and auditing</li>
                        </ul>
                    </div>
                </div>
            </div>
